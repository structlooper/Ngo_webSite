...
<header class="header_area ">
        <div class="main_menu border border-dark pt-4 rounded" style="background-color:cornflowerblue;  " >
            <div class="container-fluid  ">
                <nav class="navbar navbar-expand-lg   navbar-light">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <a class="navbar-brand logo_h" href="/"><img src="/icons/lgo.png" alt="not found" width="50px" height="50px"><div class="text-light">Charity</div></a>
