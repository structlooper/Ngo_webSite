        ...
        <div id="carouselExampleControls" class="carousel slide rounded" data-ride="carousel">
                <div class="carousel-inner">
                        ...
                        <div class="carousel-item @if($loop->first) active @endif">
                          ...
                          <img class="d-block w-100" src="{{asset('uploades/ourWork/health/slideImage\\') . $data->image}}" alt="First slide" width='1146px' height='450px'>
                              <div class="container">
          ...
          <div class=' text-dark bg-light'>
                <div class='container py-2 ' >
                      <div class="row featurette">
                          <div class="col-md-7">
                            <h2 class="featurette-heading"><u>{{$sidedata->heading}}</u></h2><span class="text">for world, our promise</span>
                            <p class="lead ">{!!$sidedata->content!!}</p>
                          </div>
                          <div class="col-md-5">
                              <img class="featurette-image img-fluid mx-auto" src="{{asset('uploades/ourWork/health/sideContentImage\\') . $sidedata->image}}" alt="500x500"   style="width: 500px; height: 350px;">
                            </div>
                        </div>
                </div>
          </div>
              ...
              <div class="position " >
                  ...
                  <div class='container  text-light'>
                      ...
                      <div class="card col-lg-4 mx-auto bg-light my-2" style="width: 18rem;">
                              <img class="card-img-top" src="{{asset('uploades/ourWork/health/specificWorkImage\\') . $specificData->image}}" alt="Card image cap">
                              <div class="card-body">
                                <div class="p2">
